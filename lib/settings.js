...
exports.movement_page = {
  ...
  "movement_table": {
    ...
    "min_amount": 5000,
    // low_warning_flag: Flag all transactions in the medium warning tier that are sent with coin amounts above this value
    "low_warning_flag": 1000000,
    // high_warning_flag: Flag all transactions in the high warning tier that are sent with coin amounts above this value
    "high_warning_flag": 100000000
  }
};
...
exports.richlist_page = {
  ...
  "wealth_distribution": {
    ...
    "colors": [ "#1d4c93", "#2e62ae", "#4579c3", "#5f90d2", "#95b4df", "#2b578f" ]
  },
